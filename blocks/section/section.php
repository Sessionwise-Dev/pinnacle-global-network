...
$classes .= get_field( 'remove_vertical_padding' ) ? ' no-y-pad' : '';;
...
echo '<section ' . ( isset( $id ) ? 'id="' . $id . '" ' : '') . 'style="position: relative;' . ( isset( $color ) ? $color : '' ) . '" class="block-section' . $classes . '">';
    echo is_admin() ? '<div class="admin-block-label">Section</div>' : '';    
